...
const projects = [
  {
    ...
    description:
      "An innovative ecommerce platform designed for clothing and accessories.",
  ...
  },
  {
    ...
    description:
      "A platform for movie enthusiasts to search and explore movies.",
  ...
  },
  {
    name: "NCCF Etinan",
    description:
      "A platform that connects members of the National Christian Corpers Fellowship.",
  ...
  },
  {
    ...
    description:
      "A simple app that allows users to get random jokes and word definitions.",
  ...
  },
  {
    name: "To-Do List App",
    description:
      "A straightforward application that helps users efficiently manage tasks.",
